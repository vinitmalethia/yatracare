        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            <a 
              ...
              className="text-2xl sm:text-[26px] font-black tracking-tight text-slate-900 hover:opacity-90 transition cursor-pointer"
            >
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`text-[15px] font-medium py-1 transition-colors relative cursor-pointer ${
                    isActive 
